...
RELAYERS_SOURCE_ERC721_WEB3_PROVIDER_URI="$(AWS_DEFAULT_REGION=${AWS_DEFAULT_REGION} /home/ubuntu/go/bin/checkenv show -raw -value aws_ssm+env_name:RELAYERS_SOURCE_ERC721_${SOURCE_INPUT}_WEB3_PROVIDER_URI)"
...
echo "RELAYERS_SOURCE_ERC721_WEB3_PROVIDER_URI=${RELAYERS_SOURCE_ERC721_WEB3_PROVIDER_URI}" >> "${PARAMETERS_ENV_PATH}"

echo
echo
echo -e "${PREFIX_INFO} Retrieving RELAYERS_TARGET_ETHEREAL_ADDRESS parameter"
RELAYERS_TARGET_ETHEREAL_ADDRESS="$(AWS_DEFAULT_REGION=${AWS_DEFAULT_REGION} /home/ubuntu/go/bin/checkenv show -raw -value aws_ssm+env_name:RELAYERS_TARGET_ETHEREAL_${TARGET_INPUT}_ADDRESS)"
...
echo "RELAYERS_TARGET_ETHEREAL_ADDRESS=${RELAYERS_TARGET_ETHEREAL_ADDRESS}" >> "${PARAMETERS_ENV_PATH}"

echo
echo
echo -e "${PREFIX_INFO} Retrieving RELAYERS_TARGET_ETHEREAL_CHAIN_ID parameter"
RELAYERS_TARGET_ETHEREAL_CHAIN_ID="$(AWS_DEFAULT_REGION=${AWS_DEFAULT_REGION} /home/ubuntu/go/bin/checkenv show -raw -value aws_ssm+env_name:RELAYERS_TARGET_ETHEREAL_${TARGET_INPUT}_CHAIN_ID)"
...
echo "RELAYERS_TARGET_ETHEREAL_CHAIN_ID=${RELAYERS_TARGET_ETHEREAL_CHAIN_ID}" >> "${PARAMETERS_ENV_PATH}"
