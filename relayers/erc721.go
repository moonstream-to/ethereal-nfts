...
// abigen --abi ERC721ABI.json --type ERC721Contract --pkg main --out erc721.go --lang go
// ERC721 interface is not going to change, which is why we didn't use a "go generate" directive.
